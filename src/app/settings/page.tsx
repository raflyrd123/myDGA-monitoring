...
import { Save, RefreshCw, Database, XCircle, Droplets, Sliders, Thermometer, ShieldAlert, Wind, Home } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      alert('Seluruh parameter threshold koper DGA berhasil disimpan ke database!');
    } catch (err: any) {
  ...
  return (
    <div className="p-10 text-[#2D365E] bg-[#F4F7FE] min-h-screen">
      ...
      <div className="space-y-12">
        ...
        {/* PANEL 1: ARRAY SENSOR GAS THRESHOLDS */}
        <div className="bg-white rounded-[45px] p-10 shadow-2xl border border-gray-100">
          <div className="flex items-center gap-3 mb-8 border-b pb-6">
            ...
            <h2 className="text-2xl font-black uppercase tracking-tighter">Gas Detection Safety Threshold Blocks</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="p-5 bg-[#F4F7FE] rounded-[25px] border border-gray-200/50 flex flex-col justify-between">
              ...
              <div className="mt-4">
                <label className="text-[9px] font-black text-orange-500 uppercase block mb-1">Trigger Alarm Threshold (PPM)</label>
            ...
            <div className="p-5 bg-[#F4F7FE] rounded-[25px] border border-gray-200/50 flex flex-col justify-between">
              <div>
                ...
                <h4 className="font-black text-lg text-[#2D365E]">Ethane (ETH)</h4>
              </div>
              <div className="mt-4">
                <label className="text-[9px] font-black text-orange-500 uppercase block mb-1">Trigger Alarm Threshold (PPM)</label>
        ...
        <div className="bg-white rounded-[45px] p-10 shadow-2xl border border-gray-100">
          <div className="flex items-center gap-3 mb-8 border-b pb-6">
            ...
            <h2 className="text-2xl font-black uppercase tracking-tighter">Thermodynamic & Liquid Safety Threshold Units</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-[#F4F7FE] rounded-[35px] border border-gray-200/50 flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-[9px] font-black text-gray-400 uppercase block mb-1">Normal to Caution Limit (°C)</label>
                  ...
                  <div>
                    <label className="text-[9px] font-black text-gray-400 uppercase block mb-1">Caution to Critical Limit (°C)</label>
            ...
            <div className="p-6 bg-[#F4F7FE] rounded-[35px] border border-gray-200/50 flex flex-col justify-between">
              <div>
                <p className="font-black text-sm uppercase tracking-wider text-[#2D365E] border-b pb-2 mb-4 flex items-center gap-2">
                  <Droplets size={14} className="text-gray-400" /> Trans Oil Color Alert
                </p>
                <div className="space-y-4">
                  <div>
                    <label className="text-[9px] font-black text-gray-400 uppercase block mb-1">Normal to Caution Limit (%)</label>
                  ...
                  <div>
                    <label className="text-[9px] font-black text-gray-400 uppercase block mb-1">Caution to Critical Limit (%)</label>
        ...
        <div className="bg-white rounded-[45px] p-10 shadow-2xl border border-gray-100">
          ...
          <div className="p-8 bg-[#F4F7FE] rounded-[35px] border border-gray-200/50">
            <p className="font-black text-xs uppercase tracking-widest text-[#2D365E] mb-6 flex items-center gap-2">
              <Home size={14} className="text-gray-400" /> Transducer Alert: JSN-SR04T Ultrasonic
            </p>
